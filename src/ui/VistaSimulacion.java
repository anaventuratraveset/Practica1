...
public class VistaSimulacion {
    ...
    public void devuelveInfoSimulacion(Poblacion p, Plato plato) {


        // Método devuelve una matriz tridimensional con la información de la simulación
//        public static int[][][] matriz3D (Poblacion p, Plato plato){
//            int numDias = (int) DAYS.between(p.getFechaInicio(), p.getFechaFin());
//            int altura = plato.getAltura();
//            int ancho = plato.getAncho();
//            int[][][] matriz3D = new int[numDias][altura][ancho];
//
//            for (int indexDia = 0; indexDia < numDias; indexDia++) {
//                for (int i = 0; i < altura; i++) {
//                    for (int j = 0; j < ancho; j++) {
//                        matriz3D[indexDia][i][j] = plato.getCelda(i, j).getComida();
//                        //aqui tengo la comida que queda en la celda
//                        matriz3D[indexDia][i][j] = plato.getCelda(i, j).getListBacterias().size();
//                        //aqui tengo el numero de bacterias que hay en la celda
//                        System.out.println(matriz3D[indexDia][i][j]);
...
//                for (int i = 0; i < altura; i++) {
//                    for (int j = 0; j < ancho; j++) {
//                        System.out.print("[" + matriz3D[dia][i][j] + "] ");
//                    }
//                    System.out.println();
//                }
//                System.out.println();
